...
1. Check the [GitHub issue tracker](https://github.com/alokverma18//Rent-a-Read/issues) to ensure the issue hasn't already been reported.
...
1. Check the [GitHub issue tracker](https://github.com/alokverma18/Rent-a-Read/issues) to see if a similar suggestion has already been made.
